...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR,'campus_exchange/templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
BASE_DIR = Path(__file__).resolve().parent.parent  # Ensure BASE_DIR is set correctly
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'campusexchange321@gmail.com'  
